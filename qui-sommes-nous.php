...
<head>
    ...
    <title>Dentiio | Qui sommes-nous ?</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top shadow-sm">
        ...
        <div class="collapse navbar-collapse justify-center pl-md-5" id="navbarNavAltMarkup">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-item nav-link nav-hover" href="index.php">Accueil</a>
                </li>
                <li class="nav-item">
                    <a class="nav-item nav-link active" href="#">Qui sommes-nous ?<span class="sr-only">(current)</span></a>
                </li>
            </ul>
            <span>
